...
import com.pdp.ecommerce.model.dto.*;
...
public class AuthController {
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Confirmation code successfully send.",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(
                                    implementation = ConfirmationTokenDto.class
                            ))),
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    description = "Login successful. Returns a JWT token and refresh token.",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(
